...
- **Switching contexts**: selecting a database aligns your active version and git branches to it (`odooDebugger.databaseSwitchBehavior`: `auto` / `ask` / `never`). The status bar shows the active project, database and version — click any of them to switch.
