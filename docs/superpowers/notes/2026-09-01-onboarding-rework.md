...
implemented on branch `v-1.3`, and the branch-model observations by
`2026-09-01-custom-repo-worktrees-design.md`. Observations 4 (the rest of the
walkthrough) and 9 (`updateActiveSettings` dead code) are still open.
